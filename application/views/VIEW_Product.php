  ...
  <div class="navbar-inner">
    ...
    <ul style="margin-left: 133px;" class="nav">
      <li><a href="<?php echo site_url('CTR_Index'); ?>"><i class="icon-home icon-large"></i> Home</a></li>
	   <li class="active"><a href="#"><i class="icon-th-list icon-large"></i> Skills</a></li>
      ...
      <div class="row">
        <div class="span9" style="width:70%;">
          <div class="latest"><i class="icon-th-list icon-large"></i> Kemampuan Saya</div>
				
			 <?php foreach ($daftar_product as $row){
        ?>
	<div style="padding-bottom: 350px; padding-left: 40px;">
	<div class="gallery1"> 
	<p><b><?php echo $row->Name;?></b><br>
	<?php echo $row->Description;?> <i class="icon-minus"></i>
	</p>
        <a href="<?php echo base_url('gambar/skil/'.$row->Photo)?>" class="img-rounded" rel="zoom-id:zoom;opacity-reverse:true;"> </a>
		<img src="<?php echo base_url('gambar/skill/'.$row->Photo)?>" width="90" alt=""> </div>
        </div>
