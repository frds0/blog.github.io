...
<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        <ul class="nav">
            <li><a href="<?php echo site_url('CTR_Admin/index')?>">Admin</a></li>
            <li><a href="<?php echo site_url('CTR_ProductAdmin/index')?>">Skills</a></li>
            <li><a href="<?php echo site_url('CTR_GalleryAdmin/index')?>">Gallery</a></li>
            <li><a href="<?php echo site_url('CTR_InfoAdmin/index')?>">Update Information</a></li>
            <li><a href="<?php echo site_url('CTR_ContactAdmin/index')?>">Messages</a></li>
            <li><a href="<?php echo site_url('CTR_ViewAdmin/index')?>">Views</a></li>
        </ul>
    </div>
</div>
<div>
